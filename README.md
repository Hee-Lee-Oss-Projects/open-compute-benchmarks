# Open Compute Benchmarks

Open, verified benchmark specifications and reference results for common numeric/HPC kernels, so developers can compare implementations fairly and reproducibly.
